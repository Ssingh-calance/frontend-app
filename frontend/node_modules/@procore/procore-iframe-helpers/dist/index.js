...
var authentication_Authentication = /** @class */ (function () {
    function Authentication(context) {
         ...
         */
        this.notifySuccess = function (payload, origin) {
            _this.context.parentWindow.postMessage({ type: "authentication.success", payload: payload }, origin ? origin : _this.context.window.location.origin);
        };
        /**
         * For use when in the [[AuthContext]]. Will notify the parent window that
         ...
         */
        this.notifyFailure = function (payload, origin) {
            _this.context.parentWindow.postMessage({ type: "authentication.failure", payload: payload }, origin ? origin : _this.context.window.location.origin);
        };
        /**
...
var parent_ParentContext = /** @class */ (function () {
    function ParentContext(config) {
        ...
        this.processMessage = function (event) {
            ...
            if (source === _this.window) {
                return;
            }
            // Reject messages that come from an unexpected domain
            var expectedDomains = _this.config.validDomains || [];
            expectedDomains.push(_this.window.location.origin);
...
function initialize(config) {
    ...
    if (window.opener !== null) {
        ...
        return new contexts_parent(config);
    }
}
